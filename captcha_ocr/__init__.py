...
__all__ = ["CHARSETS", "Predictor", "base64_captcha", "newapi_bitmap", "predict", "predict_bytes"]
...
def __getattr__(name: str):
    ...
    if name in ("base64_captcha", "newapi_bitmap", "collect", "generator", "matcher",
